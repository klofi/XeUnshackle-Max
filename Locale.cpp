...
LocalisationMessages_t english = {
    ...
    // Save Auto-Start
    L"Auto-Start saved to XeUnshackleConfig.txt",
    L"Failed to save XeUnshackleConfig.txt!",
    // Custom boot video
    L"Could not play XeUnshackleVideo.wmv!",
    // Main Screen Text
    ...
    GLYPH_A_BUTTON L" Show keys",
    GLYPH_A_BUTTON L" Hide keys",
...
LocalisationMessages_t spanish = {
    ...
    // Save Auto-Start
    L"Inicio Automático guardado en XeUnshackleConfig.txt",
    L"¡Error al guardar XeUnshackleConfig.txt!",
    // Custom boot video
    L"¡No se pudo reproducir XeUnshackleVideo.wmv!",
    // Main Screen Text
    ...
    GLYPH_A_BUTTON L" Mostrar claves",
    GLYPH_A_BUTTON L" Ocultar claves",
...
LocalisationMessages_t brazilian_portuguese = {
    ...
    // Save Auto-Start
    L"Início Automático salvo em XeUnshackleConfig.txt",
    L"Falha ao salvar o XeUnshackleConfig.txt!",
    // Custom boot video
    L"Não foi possível reproduzir XeUnshackleVideo.wmv!",
    // Main Screen Text
    ...
    GLYPH_A_BUTTON L" Mostrar chaves",
    GLYPH_A_BUTTON L" Ocultar chaves",
